    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/guoxiang.jpg" alt="Image" style="object-fit: cover;"/></a></div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect d-flex align-items-center justify-content-center"><img src="images/portfolio/dashboard.jpg" alt="Image"/>
                    <figcaption>
  ...
  <div class="container cc-experience">
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Jun 2013 – Jun 2014</p>
            <div class="h5">The Advantage Group</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">AngularJS Front end Developer</div>
            <p>
              Technologies: AngularJS, Node, HTML5, CSS3(SCSS), TypeScript, Bootstrap, REST APIs, JIRA, Agile Scrum, GIT, Webstorm.<br>
              - Designed dynamic and multi-browser compatible pages using HTML, CSS, JQuery, JavaScript, and AngularJS.<br>
              - Used AngularJS components like modules, controllers, and built-in and synchronizing models with single page Applications (SPA).<br>
              - Experience integrating RESTful services (API’s). Used JSON for data transfer between front end and back end, used SQL Queries to interact with Oracle database.<br>
              - Worked with JIRA, which is managing project requirements and tasks. Used GitHub as version control.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Dec 2010 – Jun 2013</p>
            <div class="h5">The Advantage Group</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">JavaScript Web Developer</div>
            <p>
              Technologies: HTML, CSS, Java, JavaScript, jQuery, JSON, Ajax, SQL Server.<br>
              - Involved in development of UI using HTML/HTML5, CSS/CSS3, JavaScript, and jQuery, AJAX, JSON.<br>
              - Involved in writing application level code to interact with APIs, Web Services using AJAX, JSON, and XML.<br>
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p class="category">University of Ottawa</p>
            <p>
              <div>1) Computer Science 101 : Binary Systems, Algorithms, C programming, Data Structures</div>
              <div>2) Software Architecture : Data Flows, Data Bases, Operating Systems</div>
            </p>
          </div>
        </div>
      </div>
